...
class CompleteConversation(Node):
    def __init__(self):
        ...
        # spin listener_response_cb
        # spin listener_result_cb
    ...
    def listener_response_cb(self):
        # checking whether its running

    def listener_result_cb(self):
        # checking if the text is valid
        # save the text as self.current_input_string
